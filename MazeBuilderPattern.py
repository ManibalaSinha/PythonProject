...
class Door(MapSite):
    ...
    def OtherSideFrom(self, Room):
        print('This door is side of room: ()'.format(Room._roomNumber))
...
class MazeGame():
    ...
    def CreateComplexMaze(self, builder):   #pass in a MazeBuilder
        builder.BuildRoom(1)
        # ...
        builder.BuildRoom(1001)             #1000 rooms, no doors, using same MazeBuilder interface
...
class StandardMazeBuilder(MazeBuilder):
    ...
    def BuildDoor(self, n1, n2):
        ...
        r1.SetSide(self.CommonWall(r1, r2), d) # Door replace wall
        r2.SetSide(self.CommonWall(r2, r1), d) # Door replace wall
